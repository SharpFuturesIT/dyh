...
class STM_LMS_Certificate_Builder {
	...
	public function admin_page() {
		 ...
		 wp_enqueue_script( 'vue2-color.js', STM_LMS_URL . '/nuxy/metaboxes/assets/js/vue-color.min.js', array( 'jquery', 'vue.js', 'vue-resource.js' ), stm_lms_custom_styles_v() );
	...
	public static function store_certificate_data( $certificate_id, $user_id, &$data ) {
		...
		foreach ( $data as &$field_data ) {
			if ( ! in_array( $field_data['type'], $save_data_keys ) ) {
				continue;
			}
